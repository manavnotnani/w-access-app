  ...
  const handleContinue = async () => {
    if (step === 5) {
      ...
      try {
        ...
        // Use the actual generated wallet address
        const walletAddress = walletKeys.address;
        ...
        const addressExists = await walletService.checkAddressExists(walletAddress);
        if (addressExists) {
        ...
        if (savedWallet) {
          toast({
            ...
            description: `Wallet "${walletName}.w-chain" (${walletAddress.slice(0, 8)}...${walletAddress.slice(-6)}) has been created and stored securely.`,
          });
